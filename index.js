...
function displayItems(){
    ...
    var KFCDOUBLE=  document.getElementById('KFCDOUBLE');
    var BURGERS=  document.getElementById('BURGERS');
  

    

    const FRIESData= foodItem.filter((item)=>item.category=='FRIES');
    const RICEData= foodItem.filter((item)=>item.category=='RICE');
    const ROLLSData= foodItem.filter((item)=>item.category=='ROLLS');
    const KFCDOUBLEData= foodItem.filter((item)=>item.category=='KFCDOUBLE');
    ...
    FRIESData.map(item=>{
        ...
        itemPrice.innerText= 'Price : UGX ' + item.price;
    ...
    ROLLSData.map(item=>{
        ...
        ROLLS.appendChild(itemCard)

    })

    KFCDOUBLEData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
        ...
        KFCDOUBLE.appendChild(itemCard)
...
const FRIESData= [...new Map(foodItem.map(item=> [item['category'],item])).values()];
...
function totalAmount(){
    ...
    document.getElementById('total-item').innerText= 'Total Item : UGX ' + cartData.length;
    document.getElementById('total-price').innerText= 'Total Price : UGX ' + sum;
    document.getElementById('m-total-amount').innerText= 'Total Price : UGX ' + sum;
}
